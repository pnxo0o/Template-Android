...
public class NavigationDrawerFragment extends Fragment {
    ...
    private RecyclerDrawerAdapter adapter;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        */
        if(savedInstanceState==null){
            ...
            ft.replace(com.frojas.francisco.activities.R.id.content_frame, fragment1);
            ft.commit();
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(com.frojas.francisco.activities.R.layout.fragment_navigation_drawer, container, false);
        recyclerView = (RecyclerView) layout.findViewById(com.frojas.francisco.activities.R.id.drawerList);
        adapter = new RecyclerDrawerAdapter(getActivity(), getData());
            ...
            public void onClick(View view, int position) {
                ...
                switch (position) {
                    case 0:
                        ...
                        break;
                    case 1:
                        ft.replace(com.frojas.francisco.activities.R.id.content_frame, fragment2);
                        break;
                    case 2:
    ...
    public void setUp(int fragmentId, DrawerLayout drawerLayout,final Toolbar toolbar) {
        ...
        this.mDrawerToggle = new ActionBarDrawerToggle
                (getActivity(),drawerLayout,toolbar, com.frojas.francisco.activities.R.string.drawer_open, com.frojas.francisco.activities.R.string.drawer_close){
